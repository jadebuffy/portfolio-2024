...
const Contact = () => {
  ...
  return (
    <section className="contactPage">
        <div id="contact">
          <img src={contact} alt='Illustration de bulles de contact' className='contact-image' loading="lazy"/>
            <div className='contact-content'>
              ...
              <div className="contact-description">
                <motion.span  initial={{x: -300, opacity: 0}} whileInView={{x: 0, opacity: 1, transition: { type: "linear", duration: 0.5, delay: 0.75 }}}><img src={phone} alt='Téléphone'/>07 82 61 48 14</motion.span>
                <motion.span  initial={{x: -300, opacity: 0}} whileInView={{x: 0, opacity: 1, transition: { type: "linear", duration: 0.5, delay: 1 }}}><img src={mail} alt='email'/>jade.buffy@hotmail.fr</motion.span>
                <motion.div  initial={{x: -300, opacity: 0}} whileInView={{x: 0, opacity: 1, transition: { type: "linear", duration: 0.5, delay: 1.25 }}}>
                  <BoutonOverlay onClick={openPDFInNewTab}>
                    Télécharger mon CV
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 53.66 54.91" className='btnImg' role="img" alt="Télécharger">
                      <g>
