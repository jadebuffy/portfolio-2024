    ...
    <section id="skills">
        ...
        <div className="skillBars">
            ...
            <motion.div className="skillBar" initial={{opacity: 0}} whileInView={{opacity: 1, transition: {duration: 0.7, delay: 1.25}}}>
                <img src={patience} alt="Bonhomme avec une tête de fleur qui médite et est serein" className="skillBarImg" loading="lazy"/>
                <div className="skillBarText">
            ...
            <motion.div className="skillBar" initial={{opacity: 0}} whileInView={{opacity: 1, transition: {duration: 0.7, delay: 1.5}}}>
                <img src={team} alt="Pièces de puzzle qui s'assemblent" className="skillBarImg" loading="lazy"/>
                <div className="skillBarText">
            ...
            <motion.div className="skillBar"  initial={{opacity: 0}} whileInView={{opacity: 1, transition: {duration: 0.7, delay: 1.75}}}>
                <img src={energy} alt="Fusée qui décole" className="skillBarImg" loading="lazy"/>
                <div className="skillBarText">
                    <h3>Jamais fatiguée !</h3>
                </div>
            </motion.div>
        </div>
        <img src={FilImg} alt='' className='filImg' loading="lazy"/>
        <img fetchpriority="high" src={backgroundImg} alt='' className='backgroundImg' loading="lazy"/>
    </section>
  )
}
